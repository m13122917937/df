...
import com.ruoyi.order.service.PddOrderIncrementService;
 ...
 */
@Service
public class PddOrderIncrementFacade implements IPddOrderIncrementFacade {

    @Autowired
    private PddOrderIncrementService pddOrderIncrementService;
    ...
    public PddOrderIncrementBO save(PddOrderIncrementParam param) {
        ...
        pddOrderIncrementService.save(domain);
    ...
    public boolean update(PddOrderIncrementParam param, PddOrderIncrementQuery query) {
        ...
        return pddOrderIncrementService.update(order, new QueryWrapper<>(queryDomain));
    }
    ...
    public PddOrderIncrementBO getByOrderSn(String orderSn) {
        ...
        PddOrderIncrement domain = pddOrderIncrementService.getOne(wrapper);
        return PddOrderIncrementCov.INSTANCE.toBO(domain);
    }
    ...
    public List<PddOrderIncrementBO> list(PddOrderIncrementQuery query) {
        ...
        List<PddOrderIncrement> list = pddOrderIncrementService.list(new QueryWrapper<>(domain));
