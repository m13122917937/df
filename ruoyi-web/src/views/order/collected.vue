  ...
  <div class="order-detail collected-order">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <!-- <span class="page-subtitle">管理确认收货订单，处理发货流程</span> -->
      </div>
      ...
      <div class="order-table-container-wrapper">
        ...
        <div class="order-table-container">
          ...
          >
            ...
            <!-- 确认收货相关列 -->
            <el-table-column prop="confirmTime" label="确认收货时间" width="200" align="center">
              <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    async fetchOrderList() {
      ...
      const res = await getConfirmList(params, {
