      ...
      <div class="header-left">
        <div class="page-title">
          ...
          <div class="page-warning">
            每周日查出二销的订单只能免责毁单，请各位老板及时关注订单情况
          </div>
        </div>
      </div>
      ...
      <div class="order-table-container-wrapper">
        ...
        <div class="order-table-container">
          ...
          >
            ...
            <el-table-column prop="subStatus" label="发货状态" width="200" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" width="300" fixed="right">
              <template slot-scope="scope">
                <div class="operation-buttons">
                  <el-button size="mini" @click="handleSubmitSerial(scope.row)">操作</el-button>
                  <el-button v-if="scope.row.handleApply == 0" size="mini" type="info" @click="handleCancelDetail(scope.row)">毁单详情</el-button>
                  <el-button v-else size="mini" type="warning" @click="handleCancelOrder(scope.row)">毁单</el-button>
                </div>
                <div class="status-message">
                  *串码验证通过且运单号已保存的将自动完成发货
                </div>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
    ...
    getTrackingNumberStatusText(trackingNumber) {
      return trackingNumber ? trackingNumber : '待上传物流单号'
    },
    ...
    handleCancelDetail(row) {
      this.cancelDetailData = { ...row }
      this.cancelDetailDialogVisible = true
    },
    handleCancelOrder(row) {
      this.cancelOrderData = { ...row }
    ...
    handleConfirmCancelOrder() {
      this.fetchOrderList()
      // 更新品牌和地区筛选
      if (this.$refs.regionSidebar && this.$refs.regionSidebar.getProvinceData) {
        this.$refs.regionSidebar.getProvinceData()
      }
      if (this.$refs.brandFilter && this.$refs.brandFilter.getBrandData) {
    ...
    // 发货规则相关方法
    handleAddOrder() {
      this.shippingRulesDialogVisible = true
    },
    handleImportOrder() {
      this.importShippingDialogVisible = true
    },
    async handleExportOrder() {
      try {
        ...
        link.download = `待发货订单_${timestamp}.xlsx`
