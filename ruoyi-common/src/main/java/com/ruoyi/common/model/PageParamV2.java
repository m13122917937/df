 ...
 */
@Data
public class PageParamV2 implements Serializable {
    ...
    public PageParamV2(final Integer page, final Integer size, final String orderBy) {
        this(page, size, orderBy, false);
    }

    public PageParamV2(final Integer page, final Integer size, final String orderBy, final Boolean reasonable) {
