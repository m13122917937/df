...
public class JkyRefundSyncJob {
    ...
    private RefundQueryParam buildQueryParam(DateTime startTime, DateTime endTime, int pageIndex) {
        ...
        param.setGmtCreateBegin(DateUtil.format(startTime, DatePattern.NORM_DATETIME_PATTERN));
        param.setGmtCreateEnd(DateUtil.format(endTime, DatePattern.NORM_DATETIME_PATTERN));
        return param;
    }
