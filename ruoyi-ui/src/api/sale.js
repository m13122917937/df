...
export function getPutinList(data, pagedata) {
  return request({
    url: `/sale/order/list?pageNum=${pagedata.pageNum}&pageSize=${pagedata.pageSize}`,
    method: "post",
    data,
  });
}
...
export function putinRevokeOrder(orderCode) {
  return request({
    url: `/sale/order/revoke/${orderCode}`,
    method: "post"
  });
}
...
export function downloadImportTemplate() {
  return request({
    url: `/sale/order/import/template`,
    method: "get",
    responseType: "blob",
  });
}
...
export function importValidate(file) {
  ...
  return request({
    url: `/sale/order/import/validate`,
    method: "post",
    data: formData,
