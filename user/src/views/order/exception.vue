  ...
  <div class="order-detail exception-order">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <!-- <span class="page-subtitle">管理异常订单，处理异常订单流程</span> -->
      </div>
        ...
        <div class="order-table-container">
          ...
          >
            ...
            <el-table-column prop="deliveryTime" label="发货时效" width="120" align="center">
              <template slot-scope="scope">
                {{ getDeliveryTimeText(scope.row.deliveryTime) }}
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="220" fixed="right" align="center">
              <template slot-scope="scope">
                <div class="operation-buttons">
                  <!-- 只有异常订单才能修改 -->
                  <el-button
                    v-if="scope.row.subStatus == 81 || scope.row.subStatus == 83"
                    size="mini"
                    type="warning"
                    plain
    ...
    <!-- 修改手机号/快递单号弹窗 -->
    <LogisticsEditDialog
      :visible.sync="logisticsEditDialogVisible"
      :order="logisticsEditOrder"
...
export default {
  ...
  data() {
    return {
      ...
      imeiDialogData: {},
      // 编辑弹窗
      logisticsEditDialogVisible: false,
      logisticsEditOrder: null
    }
  },
  computed: {
  },
  ...
  methods: {
    ...
    handleEditOrder(row) {
      this.logisticsEditOrder = {
        orderCode: row.orderCode,
        logisticsCode: row.trackingCompanyCode || row.trackingCompany || '',
        logisticsNo: row.trackingNumber || '',
        phone: row.phone || ''
      }
      this.logisticsEditDialogVisible = true
    },
    handleLogisticsEditSuccess() {
      this.logisticsEditDialogVisible = false
      this.fetchOrderList()
    },
    // 重置搜索
